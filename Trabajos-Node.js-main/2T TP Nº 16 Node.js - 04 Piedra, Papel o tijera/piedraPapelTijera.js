...
function piedraPapelTijera(string) {
    ...
    let piedraPapelTijera2 = ["piedra", "papel", "tijera"];
    let numeroAr = NumerosAleatorios(0, 2);
    let respuestaAleatoria = piedraPapelTijera[numeroAr];
    let string3 = "";
    ...
    switch (string) {
        case "p":
            if (respuestaAleatoria == "t") {
                ...
                string2 = "You Loose! <br> El servidor ha elegido " + piedraPapelTijera2[numeroAr];
            }
            if (respuestaAleatoria == "p") {
                string2 = "Empate! <br> El servidor ha elegido " + piedraPapelTijera2[numeroAr];
            }
            break;
        case "a":
            if (respuestaAleatoria == "p") {
